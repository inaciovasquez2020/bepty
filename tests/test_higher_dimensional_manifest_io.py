...
from bepty.higher_dimensional_manifest_io import (
    read_higher_dimensional_manifest,
    write_higher_dimensional_manifest,
)
...
def test_higher_dimensional_manifest_io_roundtrip(tmp_path: Path):
    ...
    assert read_higher_dimensional_manifest(path) == manifest
